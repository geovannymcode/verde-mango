# Historial de revisión de la API — fases 1 a 8

Archivo histórico conservado en 9a (2026-09-25). **No es el estado vigente**: contiene
afirmaciones superadas por fases posteriores. Consultar [api-gaps.md](api-gaps.md) para
la clasificación actual y la fase de resolución.
