...
import com.geovannycode.verdemango.recipes.web.CreateRecipeRequest
import com.geovannycode.verdemango.recipes.web.RecipeFilterParams
import com.geovannycode.verdemango.recipes.web.RecipeListResponse
import com.geovannycode.verdemango.recipes.web.RecipeResponse
...
class RecipeService(
    ...
    fun getPublishedRecipes(page: Int, size: Int): PageResponse<RecipeListResponse> {
        ...
        return PageResponse.of(
            ...
            page = page, size = size, totalElements = recipePage.totalElements
        )
    }
    ...
    fun searchRecipes(params: RecipeFilterParams): PageResponse<RecipeListResponse> {
        ...
        return PageResponse.of(
            content = recipePage.content.map { RecipeListResponse.from(it) },
            page = params.page, size = params.size, totalElements = recipePage.totalElements
        )
    }
