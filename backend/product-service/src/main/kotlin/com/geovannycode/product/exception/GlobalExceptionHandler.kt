package com.geovannycode.product.exception
...
class GlobalExceptionHandler {
    ...
    fun handleIllegalArgument(
        ...
        logger.warn("Argumento/Estado inválido: ${ex.message}")
        return ResponseEntity
            .status(HttpStatus.BAD_REQUEST)
            .body(ErrorResponse.of(ex.message ?: "Solicitud inválida", "BAD_REQUEST", request.requestURI))
    }
